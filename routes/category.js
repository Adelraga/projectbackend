...
router.post("/createCategory",   upload.single("imageUrl"),categoryController.createCategory);
...
router.get(
  ...
  router.patch("/:categoryId", verifyToken, upload.single("imageUrl"),categoryController.patchCategoryImage);
